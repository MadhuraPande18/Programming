...
accuracy=accuracy_score(Y_test,Y_pred)  #compare real ans key with my ans key
...
#########################################################
# Step 10 : Plot Confusion Matrix Display
#########################################################

print(Border)
print("Step 10:Plot confusion matrix display")
print(Border)

data = ConfusionMatrixDisplay(confusion_matrix=cm,display_labels=model.classes_)
                                                  #lables=setosa,verginica etc
data.plot()
